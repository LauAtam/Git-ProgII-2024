...
namespace U1___Problema_5_v2.Datos
{
    public class DBHelper
    {
        ...
        private DBHelper()
        {
            _conexion = new SqlConnection("Data Source=lautaroatampiz;Initial Catalog=Facturas_v2;Integrated Security=True");
        }
        ...
        public DataTable? EjecutarSP(string spName, List<ParametroSQL>? parametros)
        {
        ...
        public int EjecutarSPDML(string spName, List<ParametroSQL>? parametros)
        {
            int filas = 0;
